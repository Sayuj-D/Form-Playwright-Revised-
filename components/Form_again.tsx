...
const Form = () => {
  ...
  const male_ref = useRef();
  const female_ref = useRef();
  const others_ref = useRef();
  // const gender_ref = useRef();
  const country_ref = useRef();
  const writing_ref = useRef();
  const design_ref = useRef();
  const coding_ref = useRef();
  const testing_ref = useRef();
  const aboutme_ref = useRef();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (Object.keys(newErros).length > 0) {
      ...
      writing_ref.current.value = false;
      design_ref.current.value = false;
      coding_ref.current.value = false;
      testing_ref.current.value = false;
